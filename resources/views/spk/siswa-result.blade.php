                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <span class="badge bg-danger">{{ ucwords(str_replace('_', ' ', $data['minat'])) }}</span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <small class="text-muted d-block">Bakat</small>
                            <span class="badge bg-warning text-dark">{{ ucfirst(str_replace('_', ' ', $data['bakat'])) }}</span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <small class="text-muted d-block">Prospek Karir</small>
                            <span class="badge bg-success">{{ ucwords(str_replace('_', ' ', $data['prospek_karir'])) }}</span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <small class="text-muted d-block">Nilai Rata-rata</small>
                            <span class="badge bg-info">{{ number_format(array_sum($data['nilai_mapel']) / count($data['nilai_mapel']), 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>

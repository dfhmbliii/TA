            ...
            <div class="form-container">
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nisn" name="nisn" value="{{ old('nisn') }}" required placeholder="Nomor Induk Siswa Nasional">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="jurusan_sma_select" onchange="handleJurusanChange(this)">
                                    ...
                                    <option value="IPA" {{ old('jurusan_sma') == 'IPA' ? 'selected' : '' }}>IPA</option>
                                    <option value="IPS" {{ old('jurusan_sma') == 'IPS' ? 'selected' : '' }}>IPS</option>
                                    <option value="Bahasa" {{ old('jurusan_sma') == 'Bahasa' ? 'selected' : '' }}>Bahasa</option>
                                    <option value="Lainnya" {{ old('jurusan_sma') && !in_array(old('jurusan_sma'), ['IPA', 'IPS', 'Bahasa']) ? 'selected' : '' }}>Lainnya</option>
                                </select>
                                <input type="text" class="form-control mt-2" id="jurusan_sma_custom" placeholder="Ketik jurusan Anda" style="display: {{ old('jurusan_sma') && !in_array(old('jurusan_sma'), ['IPA', 'IPS', 'Bahasa']) ? 'block' : 'none' }};" value="{{ old('jurusan_sma') && !in_array(old('jurusan_sma'), ['IPA', 'IPS', 'Bahasa']) ? old('jurusan_sma') : '' }}">
                                <input type="hidden" id="jurusan_sma" name="jurusan_sma" value="{{ old('jurusan_sma') }}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="asal_sekolah" name="asal_sekolah" value="{{ old('asal_sekolah') }}" required placeholder="Nama sekolah lengkap">
                    </div>

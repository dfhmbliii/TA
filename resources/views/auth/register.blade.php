                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jurusan_sma" name="jurusan_sma" value="{{ old('jurusan_sma') }}" required placeholder="Contoh: IPA, IPS, Teknik Komputer">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="tahun_lulus" name="tahun_lulus" value="{{ old('tahun_lulus') }}" required placeholder="Contoh: 2023">
                            </div>
                        </div>
                    </div>

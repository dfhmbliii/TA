    ...
    <div class="container">
        ...
        <div class="info-box">
            <div class="info-row">
                ...
                <span class="info-value">{{ $result->siswa->nama ?? '-' }}</span>
            </div>
            <div class="info-row">
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ $result->siswa->jurusan ?? '-' }}</span>
            </div>
            <div class="info-row">
        ...
        <div class="score-card">
            ...
            <div class="score-badge">{{ $result->category }}</div>
        </div>
        ...
        <div class="recommendation">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <div>
                    ...
                    <div class="recommendation-score">{{ number_format($prodiScore, 2) }}/100</div>
                </div>
                <div style="text-align: right;">
                    <div style="font-size: 12px; opacity: 0.9;">Tingkat Kesesuaian</div>
                    <div style="font-size: 20px; font-weight: 700; margin-top: 5px;">{{ $scoreCategory }}</div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    <td><span class="badge badge-danger">{{ strtoupper($inputData['minat'] ?? '-') }}</span></td>
                    <td><span class="badge badge-warning">{{ strtoupper($inputData['bakat'] ?? '-') }}</span></td>
                    <td><span class="badge badge-success">{{ strtoupper($inputData['prospek_karir'] ?? '-') }}</span></td>
        ...
        <div class="section">
            ...
            <div class="grid-4">
                <div class="grid-item">
                    ...
                    <div class="grid-item-value">{{ number_format($criteriaValues['minat'] ?? 0, 2) }}</div>
                </div>
                <div class="grid-item">
                    <div class="grid-item-label">Bakat</div>
                    <div class="grid-item-value">{{ number_format($criteriaValues['bakat'] ?? 0, 2) }}</div>
                </div>
                <div class="grid-item">
                    <div class="grid-item-label">Prospek Karir</div>
                    <div class="grid-item-value">{{ number_format($criteriaValues['prospek_karir'] ?? 0, 2) }}</div>
                </div>
                <div class="grid-item">
                    <div class="grid-item-label">Akademik</div>
                    <div class="grid-item-value">{{ number_format($criteriaValues['akademik'] ?? 0, 2) }}</div>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="background: #e5e7eb; height: 8px; border-radius: 4px; overflow: hidden;">
                                <div style="width: {{ $weights['minat'] ?? 0 }}%; background: #4f46e5; height: 100%;"></div>
                            </div>
                        </td>
                        <td style="text-align: right; font-weight: 600;">{{ number_format($weights['minat'] ?? 0, 2) }}%</td>
                    </tr>
                    <tr>
                        <td>Bakat</td>
                        <td>
                            <div style="background: #e5e7eb; height: 8px; border-radius: 4px; overflow: hidden;">
                                <div style="width: {{ $weights['bakat'] ?? 0 }}%; background: #7c3aed; height: 100%;"></div>
                            </div>
                        </td>
                        <td style="text-align: right; font-weight: 600;">{{ number_format($weights['bakat'] ?? 0, 2) }}%</td>
                    </tr>
                    <tr>
                        <td>Prospek Karir</td>
                        <td>
                            <div style="background: #e5e7eb; height: 8px; border-radius: 4px; overflow: hidden;">
                                <div style="width: {{ $weights['prospek_karir'] ?? 0 }}%; background: #10b981; height: 100%;"></div>
                            </div>
                        </td>
                        <td style="text-align: right; font-weight: 600;">{{ number_format($weights['prospek_karir'] ?? 0, 2) }}%</td>
                    </tr>
                    <tr>
                        <td>Akademik</td>
                        <td>
                            <div style="background: #e5e7eb; height: 8px; border-radius: 4px; overflow: hidden;">
                                <div style="width: {{ $weights['akademik'] ?? 0 }}%; background: #f59e0b; height: 100%;"></div>
                            </div>
                        </td>
                        <td style="text-align: right; font-weight: 600;">{{ number_format($weights['akademik'] ?? 0, 2) }}%</td>
                    </tr>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">{{ number_format($detail['score'] ?? 0, 2) }}</td>
                        <td style="text-align: right;">{{ number_format(($detail['weight'] ?? 0) * 100, 2) }}%</td>
                        <td style="text-align: right; font-weight: 600;">{{ number_format($detail['weighted'] ?? 0, 2) }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>

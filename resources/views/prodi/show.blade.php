...
<div class="content-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted">
                <span class="badge bg-secondary me-2">{{ $prodi->nama_fakultas }}</span>
    ...
    <div class="card-body">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="ringkasan" role="tabpanel">
                ...
                @if($prodi->deskripsi)
                    <p class="text-muted">{{ $prodi->deskripsi }}</p>
                @else
            ...
            <div class="tab-pane fade" id="visi" role="tabpanel">
                ...
                @if($prodi->visi_misi)
                    <div class="content-text">
                        {!! nl2br(e($prodi->visi_misi)) !!}
                    </div>
                @elseif($prodi->visi_misi_url)
                    <div class="alert alert-info mb-3">
                        <i class="fas fa-external-link-alt me-2"></i>
                        Visi & Misi tersedia di website resmi program studi.
                    </div>
                    <a href="{{ $prodi->visi_misi_url }}" target="_blank" class="btn btn-primary">
            ...
            <div class="tab-pane fade" id="prospek" role="tabpanel">
                ...
                @if($prodi->prospek_kerja)
                    <div class="content-text">
                        {!! nl2br(e($prodi->prospek_kerja)) !!}
                    </div>
                @elseif($prodi->prospek_url)
                    <div class="alert alert-info mb-3">
                        <i class="fas fa-external-link-alt me-2"></i>
                        Informasi prospek kerja tersedia di website resmi program studi.
                    </div>
                    <a href="{{ $prodi->prospek_url }}" target="_blank" class="btn btn-primary">
            ...
            <div class="tab-pane fade" id="kurikulum" role="tabpanel">
                ...
                @if($prodi->kurikulum_data && count($prodi->kurikulum_data) > 0)
                    <!-- Summary Info -->
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <div class="card border-primary">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="mb-0">{{ $prodi->jumlah_semester ?? 8 }}</h3>
                        ...
                        <div class="col-md-4">
                            <div class="card border-success">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="mb-0">{{ $calculatedTotalSks ?: ($prodi->total_sks ?? '-') }}</h3>
                        ...
                        <div class="col-md-4">
                            <div class="card border-info">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="mb-0">{{ count($prodi->kurikulum_data) }}</h3>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="btn-group flex-wrap" role="group">
                            ...
                            @for($i = 1; $i <= ($prodi->jumlah_semester ?? 8); $i++)
                                <button class="btn btn-sm btn-outline-primary" data-semester="{{ $i }}">Semester {{ $i }}</button>
                            @endfor
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-bordered">
                            ...
                            <tbody id="kurikulumTableBody">
                                @foreach($prodi->kurikulum_data as $mk)
                                    <tr data-semester="{{ $mk['semester'] ?? 1 }}">
                                        <td class="text-center">
                                            <span class="badge bg-primary">{{ $mk['semester'] ?? 1 }}</span>
                                        </td>
                                        <td>
                                            <code>{{ $mk['kode'] ?? '-' }}</code>
                                        </td>
                                        <td>
                                            ...
                                            @if(isset($mk['prasyarat']) && $mk['prasyarat'])
                                                <br><small class="text-muted">
                                                    <i class="fas fa-link me-1"></i>Prasyarat: {{ $mk['prasyarat'] }}
                                                </small>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <span class="badge bg-success">{{ $mk['sks'] ?? 0 }} SKS</span>
                                        </td>
                                        <td>
                                            @php
                                                $kategoriConfig = [
                                            ...
                                            @endphp
                                            <span class="badge bg-{{ $config['bg'] }}">{{ $config['label'] }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                    ...
                    @if($prodi->kurikulum_url)
                        <div class="alert alert-info mt-3">
                            <i class="fas fa-external-link-alt me-2"></i>
                            Untuk informasi kurikulum lengkap dan terbaru, kunjungi
                            <a href="{{ $prodi->kurikulum_url }}" target="_blank" class="alert-link">

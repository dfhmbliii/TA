...
<head>
    ...
    <title>@yield('title', 'Pilihanku')</title>
                ...
                <div class="d-flex flex-column h-100">
                    ...
                    <div class="sidebar-nav">
                        <ul class="nav nav-pills flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('siswa.index') }}" class="nav-link {{ request()->routeIs('siswa.*') && !request()->routeIs('siswa.dashboard') ? 'active' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('reports.spk-analysis') }}" class="nav-link {{ request()->routeIs('reports.spk-analysis*') ? 'active' : '' }}">
                            ...
                            @if(Auth::check() && Auth::user()->role === 'admin')
                            <li class="nav-item">
                                <a href="{{ route('spk.dashboard') }}" class="nav-link {{ request()->routeIs('spk.*') || request()->routeIs('prodi.analysis') || request()->routeIs('prodi.list') ? 'active' : '' }}">
                                    <i class="fas fa-chart-line"></i>
                            ...
                            @if(Auth::check() && in_array(Auth::user()->role, ['siswa', 'mahasiswa']))
                            <li class="nav-item">
                                <a href="{{ route('siswa-spk.form') }}" class="nav-link {{ request()->routeIs('siswa-spk.*') ? 'active' : '' }}">
                                    <i class="fas fa-chart-line"></i>
                                    <span>SPK Analysis</span>
                                </a>
                            </li>
                            ...
                            @if(Auth::check() && in_array(Auth::user()->role, ['siswa', 'mahasiswa']))
                            <li class="nav-item">
                                <a href="{{ route('spk.history') }}" class="nav-link {{ request()->routeIs('spk.history') ? 'active' : '' }}">
                            ...
                            @if(Auth::check() && Auth::user()->role === 'admin')
                            <li class="nav-item">
                                <a href="{{ route('admin.announcement.form') }}" class="nav-link {{ request()->routeIs('admin.announcement.*') ? 'active' : '' }}">
                                    <i class="fas fa-bullhorn"></i>
                                    <span>Pengumuman</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.deletion-requests') }}" class="nav-link {{ request()->routeIs('admin.deletion-requests*') ? 'active' : '' }}">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="mb-3 text-center">
                            <a href="{{ route('notifications.index') }}" class="btn btn-sm btn-outline-light w-100 position-relative">
                                <i class="fas fa-bell"></i> Notifikasi
                                @if($notifUnread > 0)
                                    <span id="notifBadge" class="badge bg-danger position-absolute rounded-pill px-2" style="top:4px;right:8px;">{{ $notifUnread }}</span>
                                @else
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="{{ Auth::user()->issiswa() ? route('siswa.profile') : route('admin.profile') }}">
                                        <i class="fas fa-user me-2"></i>Profile
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ Auth::user()->issiswa() ? route('siswa.settings') : route('admin.settings') }}">

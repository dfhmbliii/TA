                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            ?>
                            <span class="badge bg-danger"><?php echo e($minatText); ?></span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            ?>
                            <span class="badge bg-warning text-dark"><?php echo e($bakatText); ?></span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            ?>
                            <span class="badge bg-success"><?php echo e($karirText); ?></span>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="mb-3">
                            <small class="text-muted d-block">Nilai Rata-rata</small>
                            <span class="badge bg-info"><?php echo e(number_format(array_sum($data['nilai_mapel'] ?? [0]) / max(count($data['nilai_mapel'] ?? [1]), 1), 2)); ?></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card shadow border-0">
            <div class="card-header bg-light">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('siswa-spk.form')); ?>" class="btn btn-sm btn-outline-primary d-print-none">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr class="collapse d-print-none" id="detail<?php echo e($index); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\tugas_akhir\resources\views/spk/siswa-result.blade.php ENDPATH**/ ?>
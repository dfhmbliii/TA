...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('siswa.password.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('siswa.notifications.update')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="email_notifications" name="email_notifications" <?php echo e((Auth::user()->email_notifications ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="spk_updates" name="spk_updates" <?php echo e((Auth::user()->spk_updates ?? true) ? 'checked' : ''); ?>>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="system_announcements" name="system_announcements" <?php echo e((Auth::user()->system_announcements ?? true) ? 'checked' : ''); ?>>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-2">
                    ...
                    <code><?php echo e(Auth::user()->id); ?></code>
                </p>
                <p class="mb-2">
                    <strong>Role:</strong><br>
                    <span class="badge bg-info"><?php echo e(ucfirst(Auth::user()->role)); ?></span>
                </p>
                <p class="mb-2">
                    <strong>Akun dibuat:</strong><br>
                    <span class="exact-time" title="Tanggal lengkap"><?php echo e(Auth::user()->created_at->format('d M Y H:i')); ?></span>
                    <small class="text-muted">• <span class="relative-time" data-time="<?php echo e(Auth::user()->created_at->toIso8601String()); ?>">memuat…</span></small>
                </p>
                <p class="mb-0">
                    <strong>Terakhir login:</strong><br>
                    <?php ($lastLogin = Auth::user()->last_login_at ?? Auth::user()->updated_at); ?>
                    <span class="exact-time" title="Tanggal lengkap"><?php echo e(optional($lastLogin)->format('d M Y H:i') ?? '-'); ?></span>
                    <?php if($lastLogin): ?>
                        <small class="text-muted">• <span class="relative-time" data-time="<?php echo e($lastLogin->toIso8601String()); ?>">memuat…</span></small>
                    <?php endif; ?>
                </p>
            </div>
        </div>
...
<div class="modal fade" id="deleteAccountModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('siswa.account.delete')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\tugas_akhir\resources\views/siswa/settings.blade.php ENDPATH**/ ?>
                    ...
                    <div class="alert alert-danger animate-fadeInUp">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="mt-1"><?php echo e($errors->first()); ?></div>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <?php if(session('error')): ?>
                    <div class="alert alert-danger animate-fadeInUp">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <strong>Error!</strong>
                                <div class="mt-1"><?php echo e(session('error')); ?></div>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                    ...
                    <div class="alert alert-success animate-fadeInUp">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="mt-1"><?php echo e(session('success')); ?></div>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <form action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <div class="text-center mb-3">
                        <p class="text-muted mb-1">Belum punya akun?
                            <a href="<?php echo e(route('register')); ?>" class="text-primary text-decoration-none fw-semibold">
                                Daftar Sekarang
                            </a>
                        </p>
                        <p class="mb-0">
                            <a href="<?php echo e(route('password.request')); ?>" class="text-decoration-none" style="color: var(--primary-color); font-weight:600;">
                                Lupa Password?
                            </a>
                        </p>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\tugas_akhir\resources\views/auth/login.blade.php ENDPATH**/ ?>
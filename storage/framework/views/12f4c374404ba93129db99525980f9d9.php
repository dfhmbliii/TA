            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong class="text-primary"><?php echo e($kriteriaCount); ?> Kriteria</strong>
                    </div>
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar" role="progressbar"
                            style="width: <?php echo e($kriteriaCount > 0 ? '100' : '0'); ?>%; background: linear-gradient(90deg, #667eea 0%, #764ba2 100%);">
                        </div>
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('spk.analysis')); ?>" class="btn btn-primary w-100"
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong class="text-info"><?php echo e($minatCount); ?> Kategori</strong>
                    </div>
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar" role="progressbar"
                            style="width: <?php echo e($minatCount > 0 ? '100' : '0'); ?>%; background: linear-gradient(90deg, #4facfe 0%, #00f2fe 100%);">
                        </div>
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('spk.minat.index')); ?>" class="btn w-100"
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong class="text-success"><?php echo e($bakatCount); ?> Kategori</strong>
                    </div>
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar" role="progressbar"
                            style="width: <?php echo e($bakatCount > 0 ? '100' : '0'); ?>%; background: linear-gradient(90deg, #43e97b 0%, #38f9d7 100%);">
                        </div>
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('spk.bakat.index')); ?>" class="btn w-100"
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong class="text-danger"><?php echo e($akademikCount); ?> Kategori</strong>
                    </div>
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar" role="progressbar"
                            style="width: <?php echo e($akademikCount > 0 ? '100' : '0'); ?>%; background: linear-gradient(90deg, #ff9a9e 0%, #fad0c4 100%);">
                        </div>
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('spk.akademik.index')); ?>" class="btn w-100"
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong class="text-primary"><?php echo e($karirCount); ?> Kategori</strong>
                    </div>
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar" role="progressbar"
                            style="width: <?php echo e($karirCount > 0 ? '100' : '0'); ?>%; background: linear-gradient(90deg, #8EC5FC 0%, #E0C3FC 100%);">
                        </div>
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('spk.karir.index')); ?>" class="btn w-100"
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <strong class="text-danger"><?php echo e($prodiCount); ?> Prodi</strong>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
                        <span class="text-muted">Dengan Alternatif:</span>
                        <strong class="text-success"><?php echo e($prodiWithAlternatives); ?> Prodi</strong>
                    </div>
                    <div class="progress" style="height: 8px;">
                        <div class="progress-bar" role="progressbar"
                            style="width: <?php echo e($prodiCount > 0 ? ($prodiWithAlternatives / $prodiCount * 100) : 0); ?>%; background: linear-gradient(90deg, #f093fb 0%, #f5576c 100%);">
                        </div>
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('prodi.list')); ?>" class="btn w-100"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tugas_akhir\resources\views/spk/dashboard.blade.php ENDPATH**/ ?>
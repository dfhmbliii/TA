...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Auth'); ?> - Pilihanku</title>
...
<body>
    <div class="auth-wrapper">
        <div class="auth-side">
            ...
            <div class="mt-auto small text-white-50">&copy; <?php echo e(date('Y')); ?> Pilihanku v1.0</div>
        </div>
        <div class="auth-form">
...
<?php /**PATH C:\laragon\tugas_akhir\resources\views/layouts/auth.blade.php ENDPATH**/ ?>
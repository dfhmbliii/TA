...
<?php $__env->startSection('title', 'Edit Kurikulum - ' . $prodi->nama_prodi); ?>
...
<div class="content-header">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted"><?php echo e($prodi->nama_prodi); ?> - <?php echo e($prodi->nama_fakultas); ?></p>
        </div>
        <div>
            <a href="<?php echo e(route('prodi.index')); ?>" class="btn btn-secondary">
                <i class="fas fa-arrow-left me-2"></i>Kembali
            </a>
            <a href="<?php echo e(route('prodi.show', $prodi->id)); ?>" class="btn btn-info" target="_blank">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="number" id="totalSks" class="form-control" value="<?php echo e($prodi->total_sks ?? 0); ?>" min="0" readonly>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="jumlahSemester" class="form-control" value="<?php echo e($prodi->jumlah_semester ?? 8); ?>" min="1" max="14">
                </div>
                <hr>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    ...
                    Daftar Mata Kuliah
                    <span class="badge bg-primary ms-2" id="countMK"><?php echo e(count($prodi->kurikulum_data ?? [])); ?></span>
                </h5>
            </div>
            <div class="card-body">
                <div id="kurikulumList">
                    ...
                    <?php if($kurikulumBySemester->isEmpty()): ?>
                    ...
                    <?php else: ?>
                        <div class="accordion" id="semesterAccordion">
                            <?php $__currentLoopData = $kurikulumBySemester; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester => $mataKuliahList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    $totalSKS = collect($mataKuliahList)->sum('sks');
                                    $jumlahMK = count($mataKuliahList);
                                ?>
                                <div class="accordion-item semester-group" data-semester="<?php echo e($semester); ?>">
                                    <h2 class="accordion-header" id="heading-semester-<?php echo e($semester); ?>">
                                        <button class="accordion-button <?php echo e($loop->first ? '' : 'collapsed'); ?>" type="button" 
                                                data-bs-toggle="collapse" data-bs-target="#collapse-semester-<?php echo e($semester); ?>" 
                                                aria-expanded="<?php echo e($loop->first ? 'true' : 'false'); ?>">
                                            <div class="d-flex justify-content-between align-items-center w-100 me-3">
                                                <div>
                                                    <i class="fas fa-graduation-cap me-2"></i>
                                                    <strong>Semester <?php echo e($semester); ?></strong>
                                                </div>
                                                <div>
                                                    <span class="badge bg-primary me-2"><?php echo e($jumlahMK); ?> MK</span>
                                                    <span class="badge bg-success"><?php echo e($totalSKS); ?> SKS</span>
                                                </div>
                                            </div>
                                        </button>
                                    </h2>
                                    <div id="collapse-semester-<?php echo e($semester); ?>" 
                                         class="accordion-collapse collapse <?php echo e($loop->first ? 'show' : ''); ?>" 
                                         data-bs-parent="#semesterAccordion">
                                        <div class="accordion-body p-2">
                                            <?php $__currentLoopData = $mataKuliahList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="list-group-item mb-2 mk-item" 
                                                     data-index="<?php echo e($loop->parent->index * 100 + $loop->index); ?>" 
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <span class="badge bg-primary me-2">Semester <span class="semester-value"><?php echo e($mk['semester'] ?? 1); ?></span></span>
                                                            <span class="badge bg-secondary me-2">
                                                                <span class="sks-value"><?php echo e($mk['sks'] ?? 0); ?></span> SKS
                                                            </span>
                                                            <span class="badge bg-<?php echo e($mk['kategori'] == 'wajib' ? 'danger' : ($mk['kategori'] == 'pilihan' ? 'warning' : 'info')); ?>">
                                                                <?php echo e(ucfirst($mk['kategori'] ?? 'wajib')); ?>

                                                            </span>
                                                        </div>
                                                        <button class="btn btn-sm btn-danger" onclick="deleteMataKuliah(<?php echo e($loop->parent->index * 100 + $loop->index); ?>)">
                                                    ...
                                                    <div class="row g-2">
                                                        <div class="col-md-3">
                                                            <input type="number" class="form-control form-control-sm mk-semester" 
                                                                   placeholder="Semester" value="<?php echo e($mk['semester'] ?? 1); ?>" min="1" max="14" onchange="reorganizeSemesters()">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="text" class="form-control form-control-sm mk-kode" 
                                                                   placeholder="Kode MK" value="<?php echo e($mk['kode'] ?? ''); ?>">
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control form-control-sm mk-nama" 
                                                                   placeholder="Nama Mata Kuliah" value="<?php echo e($mk['nama'] ?? ''); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row g-2 mt-1">
                                                        <div class="col-md-2">
                                                            <input type="number" class="form-control form-control-sm mk-sks" 
                                                                   placeholder="SKS" value="<?php echo e($mk['sks'] ?? 0); ?>" min="0" max="10">
                                                        </div>
                                                        <div class="col-md-2">
                                                            <input type="text" class="form-control form-control-sm mk-praktikum"
                                                                   placeholder="Praktikum (opsional)" value="<?php echo e($mk['praktikum'] ?? ''); ?>">
                                                        </div>
                                                        <div class="col-md-3">
                                                            <select class="form-select form-select-sm mk-kategori">
                                                                <option value="wajib" <?php echo e(($mk['kategori'] ?? '') == 'wajib' ? 'selected' : ''); ?>>Wajib</option>
                                                                <option value="pilihan" <?php echo e(($mk['kategori'] ?? '') == 'pilihan' ? 'selected' : ''); ?>>Pilihan</option>
                                                                <option value="mkwu" <?php echo e(($mk['kategori'] ?? '') == 'mkwu' ? 'selected' : ''); ?>>MKWU</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-5">
                                                            <input type="text" class="form-control form-control-sm mk-prasyarat" 
                                                                   placeholder="Prasyarat (opsional)" value="<?php echo e($mk['prasyarat'] ?? ''); ?>">
                                                        </div>
                                                    </div>
                                                </div>
...
<form id="kurikulumForm" action="<?php echo e(route('prodi.kurikulum.update', $prodi->id)); ?>" method="POST" style="display:none;">
    <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="modalSemester" class="form-select">
                            <?php for($i=1;$i<=($prodi->jumlah_semester ?? 8);$i++): ?>
                                <option value="<?php echo e($i); ?>" <?php echo e($i==1? 'selected' : ''); ?>>Semester <?php echo e($i); ?></option>
                            <?php endfor; ?>
                        </select>
                    </div>
                    <div class="col-md-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tugas_akhir\resources\views/prodi/kurikulum.blade.php ENDPATH**/ ?>